...
function CartComponent_div_24_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CartComponent_div_24_div_1_Template_a_click_15_listener() {
      ...
      return \u0275\u0275resetView(ctx_r5.removeFromCart(item_r4.cartDetailId));
    });
    \u0275\u0275element(16, "i", 45);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("src", item_r4.productDto.imageUrl, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r4.productDto.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", item_r4 == null ? null : item_r4.productDto == null ? null : item_r4.productDto.description, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" $$ ", item_r4 == null ? null : item_r4.productDto == null ? null : item_r4.productDto.price, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", item_r4 == null ? null : item_r4.count, "");
  }
}
...
function CartComponent_button_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CartComponent_button_36_Template_button_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r7.RemoveCoupon());
    });
...
function CartComponent_button_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CartComponent_button_37_Template_button_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r9.ApplyCoupon());
    });
    \u0275\u0275text(1, " Apply ");
    \u0275\u0275elementEnd();
  }
...
var _CartComponent = class _CartComponent {
  ...
  RemoveCoupon() {
    this.cartItems.cartHeader.couponCode = "";
    this.cartService.RemoveCartCoupon().subscribe((res) => {
      if (res.isSuccess) {
        this.loadCartItems();
        console.log(res);
      }
...
_CartComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartComponent, selectors: [["app-cart"]], decls: 57, vars: 16, consts: [["method", "post", 1, "container", "mt-4"], [1, "card", "border-dark", "shadow"], [1, "card-header", "bg-dark", "text-light", "row"], [1, "col-6"], [1, "text-success"], [1, "bi", "bi-cart"], [1, "col-6", "text-end"], [1, "btn", "btn-outline-warning", "mt-2", "btn-sm"], [1, "card-body"], [1, "d-none", "d-lg-block"], [1, "row", "text-info"], [1, "col-lg-2"], [1, "col-lg-5"], [1, "col-lg-1"], [4, "ngIf"], [1, "row", "mt-3"], [1, "col-12"], [1, "text-primary"], [1, "row"], [1, "col-12", "col-md-3", "mb-2"], [1, "input-group"], [1, "input-group-text", "bg-primary", "text-light"], ["type", "search", 1, "form-control", "form-control-sm", 2, "width", "80px", 3, "ngModel", "ngModelChange"], ["type", "button", "class", "btn btn-danger btn-sm ms-2", 3, "click", 4, "ngIf"], ["type", "button", "class", "btn btn-success btn-sm ms-2", 3, "click", 4, "ngIf"], [1, "row", "mt-2"], [1, "col-12", "text-end"], [1, "text-primary", "total-cost"], [1, "bi", "bi-currency-dollar"], [1, "badge", "bg-success", "p-2", 2, "font-size", "18px", "box-shadow", "5px 9px 13px rgba(0, 0, 0, 0.1)", "width", "135px", "display", "inline-block", "margin-left", "10px", "margin-right", "10px"], [1, "badge", "bg-warning", "text-dark", "p-2", 2, "font-size", "18px", "box-shadow", "5px 9px 13px rgba(0, 0, 0, 0.1)", "width", "135px", "display", "inline-block", "margin-left", "10px", "margin-top", "5px", "margin-right", "10px"], [1, "card-footer", "row"], [1, "col-12", "col-md-6", "mb-2"], ["type", "submit", 1, "btn", "btn-outline-danger", "form-control"], [1, "col-12", "col-md-6"], ["disabled", "", "value", "Checkout (Coming Soon!)", 1, "btn", "btn-success", "w-100"], ["class", "row mb-3", 4, "ngFor", "ngForOf"], [1, "row", "mb-3"], [1, "col-12", "col-md-2", "text-center"], ["width", "80", 1, "rounded", 3, "src"], [1, "col-12", "col-md-5"], [2, "font-size", "14px"], [1, "col-6", "col-md-2", "pt-md-4", 2, "font-size", "14px"], [1, "col-6", "col-md-1", "pt-md-4", "text-center"], [1, "btn", "btn-sm", "btn-danger", 3, "click"], [1, "bi", "bi-trash-fill"], ["type", "button", 1, "btn", "btn-danger", "btn-sm", "ms-2", 3, "click"], ["type", "button", 1, "btn", "btn-success", "btn-sm", "ms-2", 3, "click"]], template: function CartComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(36, CartComponent_button_36_Template, 2, 0, "button", 23)(37, CartComponent_button_37_Template, 2, 0, "button", 24);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(38, "div", 25)(39, "div", 26)(40, "p", 27);
    \u0275\u0275element(41, "i", 28);
    \u0275\u0275text(42, " Total Price: ");
    \u0275\u0275elementStart(43, "span", 29);
    \u0275\u0275text(44);
    \u0275\u0275pipe(45, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275text(46, " Order Discount: ");
    \u0275\u0275elementStart(47, "span", 30);
    \u0275\u0275text(48);
    \u0275\u0275pipe(49, "currency");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(50, "div", 31)(51, "div", 32)(52, "button", 33);
    \u0275\u0275text(53, " Email Cart ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "div", 34)(55, "button", 35);
    \u0275\u0275text(56, " Checkout (Coming Soon!) ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(24);
    ...
    \u0275\u0275property("ngIf", !ctx.CouponCodeAdded);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(45, 6, ctx.cartHeader == null ? null : ctx.cartHeader.cartTotal, "USD", "symbol", "1.2-2"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(49, 11, ctx.cartHeader == null ? null : ctx.cartHeader.discount, "USD", "symbol", "1.2-2"), " ");
  }
...
//# sourceMappingURL=chunk-UYWE4BIJ.js.map

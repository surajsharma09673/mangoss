...
function CartComponent_div_24_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "img", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 31)(4, "h5");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 32);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 33)(9, "span");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 33)(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 34)(15, "a", 35);
...
function CartComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, CartComponent_div_24_div_1_Template, 17, 5, "div", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
_CartComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartComponent, selectors: [["app-cart"]], decls: 44, vars: 9, consts: [["method", "post", 1, "container", "mt-4"], [1, "card", "border-dark", "shadow"], [1, "card-header", "bg-dark", "text-light", "row"], [1, "col-6"], [1, "text-success"], [1, "bi", "bi-cart"], [1, "col-6", "text-end"], [1, "btn", "btn-outline-warning", "mt-2", "btn-sm"], [1, "card-body"], [1, "d-none", "d-lg-block"], [1, "row", "text-info"], [1, "col-lg-2"], [1, "col-lg-5"], [1, "col-lg-1"], [4, "ngIf", "ngIfElse"], ["emptyCart", ""], [1, "row", "mt-2"], [1, "col-12", "text-end"], [1, "text-primary", "total-cost"], [1, "bi", "bi-currency-dollar"], [1, "badge", "bg-success", "p-2", 2, "font-size", "18px", "box-shadow", "5px 9px 13px rgba(0, 0, 0, 0.1)", "width", "135px", "display", "inline-block", "margin-left", "10px", "margin-right", "10px"], [4, "ngIf"], [1, "card-footer", "row"], [1, "col-12", "col-md-6", "mb-2"], ["type", "submit", 1, "btn", "btn-outline-danger", "form-control"], [1, "col-12", "col-md-6"], ["disabled", "", "value", "Checkout (Coming Soon!)", 1, "btn", "btn-success", "w-100"], ["class", "row mb-3", 4, "ngFor", "ngForOf"], [1, "row", "mb-3"], [1, "col-12", "col-md-2", "text-center"], ["width", "80", 1, "rounded", 3, "src"], [1, "col-12", "col-md-5"], [2, "font-size", "14px"], [1, "col-6", "col-md-2", "pt-md-4", 2, "font-size", "14px"], [1, "col-6", "col-md-1", "pt-md-4", "text-center"], [1, "btn", "btn-sm", "btn-danger", 3, "click"], [1, "bi", "bi-trash-fill"], [1, "text-center"], [1, "text-muted"], [1, "badge", "bg-warning", "text-dark", "p-2", 2, "font-size", "18px", "box-shadow", "5px 9px 13px rgba(0, 0, 0, 0.1)", "width", "135px", "display", "inline-block", "margin-left", "10px", "margin-top", "5px", "margin-right", "10px"]], template: function CartComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(31, "i", 19);
    \u0275\u0275text(32, " Total Price: ");
    \u0275\u0275elementStart(33, "span", 20);
    \u0275\u0275text(34);
    \u0275\u0275pipe(35, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275template(36, CartComponent_span_36_Template, 5, 6, "span", 21);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(37, "div", 22)(38, "div", 23)(39, "button", 24);
    \u0275\u0275text(40, " Email Cart ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "div", 25)(42, "button", 26);
    \u0275\u0275text(43, " Checkout (Coming Soon!) ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(35, 4, ctx.cartHeader == null ? null : ctx.cartHeader.cartTotal, "USD", "symbol", "1.2-2"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx.cartHeader && ctx.cartHeader.discount > 0);
  }
}, dependencies: [\u0275NgNoValidate, NgControlStatusGroup, NgForm, NgForOf, NgIf, CurrencyPipe], styles: ["\n\n/*# sourceMappingURL=cart.component.css.map */"] });
...
//# sourceMappingURL=chunk-DB4P6LDV.js.map

...
_OrderDetailsCardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderDetailsCardComponent, selectors: [["app-order-details-card"]], decls: 2, vars: 0, template: function OrderDetailsCardComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "order-details-card works!");
    \u0275\u0275elementEnd();
  }
...
_OrderSummaryComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderSummaryComponent, selectors: [["app-order-summary"]], decls: 2, vars: 0, template: function OrderSummaryComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "order-summary works!");
    \u0275\u0275elementEnd();
  }
}, styles: ["\n\n/*# sourceMappingURL=order-summary.component.css.map */"] });
var OrderSummaryComponent = _OrderSummaryComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrderSummaryComponent, { className: "OrderSummaryComponent", filePath: "src\\app\\HomePage\\cart\\order-summary\\order-summary.component.ts", lineNumber: 8 });
})();
...
//# sourceMappingURL=chunk-LQFCUCDJ.js.map

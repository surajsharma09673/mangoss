...
_OrderSummaryComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderSummaryComponent, selectors: [["app-order-summary"]], decls: 28, vars: 3, consts: [[3, "formGroup", "ngSubmit"], [1, "border", "mt-2", "p-4", "rounded"], [1, "container", "row"], [1, "col-md-7", "col-12"], [1, "text-warning", "mb-2", 2, "font-size", "25px"], [1, "col-md-5", "col-12"], ["routerLink", "../cart", 1, "btn", "btn-outline-warning", "form-control"], [1, "col-7"], [1, "row", "pt-2"], [1, "col-12", "py-2"], ["formControlName", "firstName", "placeholder", "First name...", 1, "form-control"], ["formControlName", "lastName", "placeholder", "Last name...", 1, "form-control"], ["formControlName", "email", "placeholder", "Email...", 1, "form-control"], ["formControlName", "phoneNumber", "placeholder", "Phone number...", 1, "form-control"], [1, "col-12", "pt-2"], [1, "col-form-label"], [1, "col-5"], [3, "cardDetails", "cartHeader"]], template: function OrderSummaryComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-HTN72SDD.js.map

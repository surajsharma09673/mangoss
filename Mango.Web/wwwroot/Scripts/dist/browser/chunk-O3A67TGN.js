...
_OrderSummaryComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderSummaryComponent, selectors: [["app-order-summary"]], decls: 32, vars: 9, consts: [[3, "formGroup", "ngSubmit"], [1, "container", "mt-4"], [1, "card", "border", "mt-2", "p-4", "rounded"], [1, "row"], [1, "col-md-7", "col-12"], [1, "text-warning", "mb-2"], [1, "col-md-5", "col-12", "text-end"], ["routerLink", "../cart", 1, "btn", "btn-outline-warning"], [1, "row", "mt-4"], [1, "row", "mb-3"], [1, "col-12"], ["formControlName", "firstName", "placeholder", "First name...", 1, "form-control"], ["class", "text-danger", 4, "ngIf"], [1, "col-12", "mt-2"], ["formControlName", "lastName", "placeholder", "Last name...", 1, "form-control"], ["formControlName", "email", "placeholder", "Email...", 1, "form-control"], ["formControlName", "phoneNumber", "placeholder", "Phone number...", 1, "form-control"], [1, "col-12", "pt-2"], [1, "col-form-label"], [1, "col-md-5", "col-12"], [3, "cardDetails", "cartHeader"], [1, "text-danger"]], template: function OrderSummaryComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-O3A67TGN.js.map

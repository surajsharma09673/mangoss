...
function CartComponent_div_24_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "img", 37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 38)(4, "h5");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 39);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 40)(9, "span");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 40)(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 41)(15, "a", 42);
...
function CartComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, CartComponent_div_24_div_1_Template, 17, 5, "div", 34);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function CartComponent_button_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 44);
    \u0275\u0275listener("click", function CartComponent_button_32_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r8 = \u0275\u0275nextContext();
...
function CartComponent_button_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 45);
    \u0275\u0275listener("click", function CartComponent_button_33_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r10 = \u0275\u0275nextContext();
...
function CartComponent_span_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 46);
    \u0275\u0275listener("click", function CartComponent_span_34_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r13);
...
_CartComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartComponent, selectors: [["app-cart"]], decls: 54, vars: 17, consts: [["method", "post", 1, "container", "mt-4"], [1, "card", "border-dark", "shadow"], [1, "card-header", "bg-dark", "text-light", "row"], [1, "col-6"], [1, "text-success"], [1, "bi", "bi-cart"], [1, "col-6", "text-end"], [1, "btn", "btn-outline-warning", "mt-2", "btn-sm"], [1, "card-body"], [1, "d-none", "d-lg-block"], [1, "row", "text-info"], [1, "col-lg-2"], [1, "col-lg-5"], [1, "col-lg-1"], [4, "ngIf"], [1, "row"], [1, "col-6", "col-md-3", "mb-2"], [1, "input-group"], [1, "input-group-text", "bg-primary", "text-light"], ["type", "text", 1, "form-control", "form-control-sm", 2, "width", "80px", 3, "ngModel", "ngModelChange"], ["type", "button", "class", "btn btn-danger btn-sm ms-2", 3, "click", 4, "ngIf"], ["type", "button", "class", "btn btn-success btn-sm ms-2", 3, "click", 4, "ngIf"], ["class", "input-group-text bg-danger text-light cursor-pointer", 3, "click", 4, "ngIf"], [1, "row", "mt-2"], [1, "col-12", "text-end"], [1, "text-primary", "total-cost"], [1, "bi", "bi-currency-dollar"], [1, "badge", "bg-success", "p-2", 2, "font-size", "18px", "box-shadow", "5px 9px 13px rgba(0, 0, 0, 0.1)", "width", "135px", "display", "inline-block", "margin-left", "10px", "margin-right", "10px"], [1, "badge", "bg-warning", "text-dark", "p-2", 2, "font-size", "18px", "box-shadow", "5px 9px 13px rgba(0, 0, 0, 0.1)", "width", "135px", "display", "inline-block", "margin-left", "10px", "margin-top", "5px", "margin-right", "10px"], [1, "card-footer", "row"], [1, "col-12", "col-md-6", "mb-2"], ["type", "submit", 1, "btn", "btn-outline-danger", "form-control"], [1, "col-12", "col-md-6"], ["disabled", "", "value", "Checkout (Coming Soon!)", 1, "btn", "btn-success", "w-100"], ["class", "row mb-3", 4, "ngFor", "ngForOf"], [1, "row", "mb-3"], [1, "col-12", "col-md-2", "text-center"], ["width", "80", 1, "rounded", 3, "src"], [1, "col-12", "col-md-5"], [2, "font-size", "14px"], [1, "col-6", "col-md-2", "pt-md-4", 2, "font-size", "14px"], [1, "col-6", "col-md-1", "pt-md-4", "text-center"], [1, "btn", "btn-sm", "btn-danger", 3, "click"], [1, "bi", "bi-trash-fill"], ["type", "button", 1, "btn", "btn-danger", "btn-sm", "ms-2", 3, "click"], ["type", "button", 1, "btn", "btn-success", "btn-sm", "ms-2", 3, "click"], [1, "input-group-text", "bg-danger", "text-light", "cursor-pointer", 3, "click"], [1, "bi", "bi-x"]], template: function CartComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(25, "hr");
    \u0275\u0275elementStart(26, "div", 15)(27, "div", 16)(28, "div", 17)(29, "span", 18);
    \u0275\u0275text(30, "Coupon:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "input", 19);
    \u0275\u0275twoWayListener("ngModelChange", function CartComponent_Template_input_ngModelChange_31_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.CouponCode, $event) || (ctx.CouponCode = $event);
      return $event;
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(32, CartComponent_button_32_Template, 2, 0, "button", 20)(33, CartComponent_button_33_Template, 2, 0, "button", 21)(34, CartComponent_span_34_Template, 2, 0, "span", 22);
    \u0275\u0275elementEnd()()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", ctx.CouponCode);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(42, 7, ctx.cartHeader == null ? null : ctx.cartHeader.cartTotal, "USD", "symbol", "1.2-2"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(46, 12, ctx.cartHeader == null ? null : ctx.cartHeader.discount, "USD", "symbol", "1.2-2"), " ");
  }
...
//# sourceMappingURL=chunk-EIU5X3JA.js.map

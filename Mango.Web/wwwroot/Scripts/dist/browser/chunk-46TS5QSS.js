...
function ProductDetailComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 10)(17, "p");
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 11)(20, "div", 12)(21, "button", 13);
    \u0275\u0275listener("click", function ProductDetailComponent_div_0_Template_button_click_21_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ProductDetailComponent_div_0_Template_input_ngModelChange_23_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.quantity, $event) || (ctx_r4.quantity = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "button", 15);
    \u0275\u0275listener("click", function ProductDetailComponent_div_0_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r5 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r5.viewCart());
    });
    \u0275\u0275text(25, "View Cart ");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(13, 8, ctx_r0.product.price, "USD", "symbol", "1.2-2"));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.numberOfItems);
  }
}
var _ProductDetailComponent = class _ProductDetailComponent {
  constructor(route, HomeproductService, router) {
    this.route = route;
...
_ProductDetailComponent.\u0275fac = function ProductDetailComponent_Factory(t) {
  return new (t || _ProductDetailComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(HomeProductService), \u0275\u0275directiveInject(Router));
};
_ProductDetailComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductDetailComponent, selectors: [["app-product-detail"]], decls: 1, vars: 1, consts: [["class", "container", 4, "ngIf"], [1, "container"], [1, "row", "mt-3", "mb-3"], [1, "col-md-12"], [1, "btn", "btn-primary", 3, "click"], [1, "row"], [1, "col-md-6"], [1, "img-fluid", 3, "src", "alt"], [1, "text-danger", 2, "font-size", "24px", "font-weight", "bold"], [1, "badge", "bg-warning", "text-white"], [1, "description-container"], [1, "mt-3"], [1, "input-group"], [1, "btn", "btn-success", 3, "click"], ["type", "number", "placeholder", "Quantity", "min", "1", 1, "form-control", "ml-2", 3, "ngModel", "ngModelChange"], [1, "btn", "btn-info", "mt-2", 3, "click"], [1, "badge", "badge-light"]], template: function ProductDetailComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ProductDetailComponent_div_0_Template, 28, 13, "div", 0);
  }
  if (rf & 2) {
...
//# sourceMappingURL=chunk-46TS5QSS.js.map

...
function CartComponent_div_24_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "img", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 43)(4, "h5");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 44);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 45)(9, "span");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 45)(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 46)(15, "a", 47);
...
function CartComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, CartComponent_div_24_div_1_Template, 17, 5, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function CartComponent_span_37_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 49);
    \u0275\u0275listener("click", function CartComponent_span_37_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r8 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r8.ClearCoupon());
    });
    \u0275\u0275element(1, "i", 50);
    \u0275\u0275elementEnd();
  }
...
function CartComponent_button_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 52);
    \u0275\u0275listener("click", function CartComponent_button_40_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r13);
...
_CartComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartComponent, selectors: [["app-cart"]], decls: 60, vars: 17, consts: [["method", "post", 1, "container", "mt-4"], [1, "card", "border-dark", "shadow"], [1, "card-header", "bg-dark", "text-light", "row"], [1, "col-6"], [1, "text-success"], [1, "bi", "bi-cart"], [1, "col-6", "text-end"], [1, "btn", "btn-outline-warning", "mt-2", "btn-sm"], [1, "card-body"], [1, "d-none", "d-lg-block"], [1, "row", "text-info"], [1, "col-lg-2"], [1, "col-lg-5"], [1, "col-lg-1"], [4, "ngIf"], [1, "row", "mt-3"], [1, "col-12"], [1, "text-primary"], [1, "row"], [1, "col-12", "col-md-3", "mb-2"], [1, "input-group"], [1, "input-group-text", "bg-primary", "text-light"], [1, "position-relative"], ["type", "search", 1, "form-control", "form-control-sm", 3, "ngModel", "ngModelChange"], ["class", "input-group-text bg-danger text-light cursor-pointer", 3, "click", 4, "ngIf"], [1, "input-group-append"], ["type", "button", "class", "btn btn-danger btn-sm", 3, "click", 4, "ngIf"], ["type", "button", "class", "btn btn-success btn-sm", 3, "click", 4, "ngIf"], [1, "row", "mt-2"], [1, "col-12", "text-end"], [1, "text-primary", "total-cost"], [1, "bi", "bi-currency-dollar"], [1, "badge", "bg-success", "p-2", 2, "font-size", "18px", "box-shadow", "5px 9px 13px rgba(0, 0, 0, 0.1)", "width", "135px", "display", "inline-block", "margin-left", "10px", "margin-right", "10px"], [1, "badge", "bg-warning", "text-dark", "p-2", 2, "font-size", "18px", "box-shadow", "5px 9px 13px rgba(0, 0, 0, 0.1)", "width", "135px", "display", "inline-block", "margin-left", "10px", "margin-top", "5px", "margin-right", "10px"], [1, "card-footer", "row"], [1, "col-12", "col-md-6", "mb-2"], ["type", "submit", 1, "btn", "btn-outline-danger", "form-control"], [1, "col-12", "col-md-6"], ["disabled", "", "value", "Checkout (Coming Soon!)", 1, "btn", "btn-success", "w-100"], ["class", "row mb-3", 4, "ngFor", "ngForOf"], [1, "row", "mb-3"], [1, "col-12", "col-md-2", "text-center"], ["width", "80", 1, "rounded", 3, "src"], [1, "col-12", "col-md-5"], [2, "font-size", "14px"], [1, "col-6", "col-md-2", "pt-md-4", 2, "font-size", "14px"], [1, "col-6", "col-md-1", "pt-md-4", "text-center"], [1, "btn", "btn-sm", "btn-danger", 3, "click"], [1, "bi", "bi-trash-fill"], [1, "input-group-text", "bg-danger", "text-light", "cursor-pointer", 3, "click"], [1, "bi", "bi-x"], ["type", "button", 1, "btn", "btn-danger", "btn-sm", 3, "click"], ["type", "button", 1, "btn", "btn-success", "btn-sm", 3, "click"]], template: function CartComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function CartComponent_Template_input_ngModelChange_36_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.CouponCode, $event) || (ctx.CouponCode = $event);
      return $event;
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(37, CartComponent_span_37_Template, 2, 0, "span", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 25);
    \u0275\u0275template(39, CartComponent_button_39_Template, 2, 0, "button", 26)(40, CartComponent_button_40_Template, 2, 0, "button", 27);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(41, "div", 28)(42, "div", 29)(43, "p", 30);
    \u0275\u0275element(44, "i", 31);
    \u0275\u0275text(45, " Total Price: ");
    \u0275\u0275elementStart(46, "span", 32);
    \u0275\u0275text(47);
    \u0275\u0275pipe(48, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275text(49, " Order Discount: ");
    \u0275\u0275elementStart(50, "span", 33);
    \u0275\u0275text(51);
    \u0275\u0275pipe(52, "currency");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(53, "div", 34)(54, "div", 35)(55, "button", 36);
    \u0275\u0275text(56, " Email Cart ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(57, "div", 37)(58, "button", 38);
    \u0275\u0275text(59, " Checkout (Coming Soon!) ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(24);
    ...
    \u0275\u0275property("ngIf", !ctx.CouponCode);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(48, 7, ctx.cartHeader == null ? null : ctx.cartHeader.cartTotal, "USD", "symbol", "1.2-2"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(52, 12, ctx.cartHeader == null ? null : ctx.cartHeader.discount, "USD", "symbol", "1.2-2"), " ");
  }
...
//# sourceMappingURL=chunk-VLCXWEJI.js.map

...
_OrderDetailsCardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderDetailsCardComponent, selectors: [["app-order-details-card"]], inputs: { orderDetails: "orderDetails" }, decls: 25, vars: 1, consts: [[1, "card", "mt-2"], [1, "card-body"], [1, "d-none", "d-lg-block"], [1, "row", "text-danger"], [1, "col-6"], [1, "col-3"], ["class", "row h-100", 4, "ngFor", "ngForOf"], [1, "row"], [1, "col-12", "text-center", "pr-4", "text-danger"], [1, "text-success"], [1, "card-footer"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-success", "form-control"], [1, "row", "h-100"], [2, "font-size", "20px"], [1, "col-3", 2, "font-size", "11px"], [2, "font-size", "17px"]], template: function OrderDetailsCardComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15, " Order Total: $$ ");
    \u0275\u0275element(16, "br");
    \u0275\u0275elementStart(17, "span", 9);
    \u0275\u0275text(18, " Order Discount: $$");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(19, "div", 10)(20, "div", 7)(21, "div", 11)(22, "button", 12)(23, "span");
    \u0275\u0275text(24, "Place Order");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(11);
    \u0275\u0275property("ngForOf", ctx.orderDetails);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrderDetailsCardComponent, { className: "OrderDetailsCardComponent", filePath: "src\\app\\HomePage\\cart\\order-details-card\\order-details-card.component.ts", lineNumber: 8 });
})();
...
var _OrderSummaryComponent = class _OrderSummaryComponent {
  ...
  getOrderDetails() {
    this.orderDetails = [
      { name: "Product 1", price: 10, count: 2 },
      { name: "Product 2", price: 20, count: 1 }
    ];
  }
  placeOrder() {
...
_OrderSummaryComponent.\u0275fac = function OrderSummaryComponent_Factory(t) {
  return new (t || _OrderSummaryComponent)(\u0275\u0275directiveInject(FormBuilder));
};
_OrderSummaryComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderSummaryComponent, selectors: [["app-order-summary"]], decls: 28, vars: 2, consts: [[3, "formGroup", "ngSubmit"], [1, "border", "mt-2", "p-4", "rounded"], [1, "container", "row"], [1, "col-md-7", "col-12"], [1, "text-warning", "mb-2", 2, "font-size", "25px"], [1, "col-md-5", "col-12"], ["routerLink", "/cart", 1, "btn", "btn-outline-warning", "form-control"], [1, "col-7"], [1, "row", "pt-2"], [1, "col-12", "py-2"], ["formControlName", "firstName", "placeholder", "First name...", 1, "form-control"], ["formControlName", "lastName", "placeholder", "Last name...", 1, "form-control"], ["formControlName", "email", "placeholder", "Email...", 1, "form-control"], ["formControlName", "phoneNumber", "placeholder", "Phone number...", 1, "form-control"], [1, "col-12", "pt-2"], [1, "col-form-label"], [1, "col-5"], [3, "orderDetails"]], template: function OrderSummaryComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275element(9, "br")(10, "br")(11, "br")(12, "hr");
    ...
    \u0275\u0275text(25, " Order will be ready in 30 minutes after placing the order. If you place an order when the restaurant is closed, it will be ready the next day. ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(26, "div", 16);
    \u0275\u0275element(27, "app-order-details-card", 17);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    \u0275\u0275property("formGroup", ctx.orderForm);
    \u0275\u0275advance(27);
    \u0275\u0275property("orderDetails", ctx.orderDetails);
  }
}, dependencies: [RouterLink, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, OrderDetailsCardComponent], styles: ["\n\n/*# sourceMappingURL=order-summary.component.css.map */"] });
var OrderSummaryComponent = _OrderSummaryComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrderSummaryComponent, { className: "OrderSummaryComponent", filePath: "src\\app\\HomePage\\cart\\order-summary\\order-summary.component.ts", lineNumber: 9 });
})();
...
//# sourceMappingURL=chunk-SVYLTCD3.js.map

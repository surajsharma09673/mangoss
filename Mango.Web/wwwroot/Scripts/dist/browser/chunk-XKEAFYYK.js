...
_OrderDetailsCardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderDetailsCardComponent, selectors: [["app-order-details-card"]], inputs: { cardDetails: "cardDetails", cartHeader: "cartHeader", orderForm: "orderForm" }, decls: 27, vars: 13, consts: [[1, "card", "mt-2"], [1, "card-body"], [1, "d-none", "d-lg-block"], [1, "row", "text-danger"], [1, "col-6"], [1, "col-3"], ["class", "row h-100", 4, "ngFor", "ngForOf"], [1, "row"], [1, "col-12", "text-center", "pr-4", "text-danger"], [1, "text-success"], [1, "card-footer"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-success", "form-control"], [1, "row", "h-100"], [2, "font-size", "20px"], [1, "col-3", 2, "font-size", "11px"], [2, "font-size", "17px"]], template: function OrderDetailsCardComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-XKEAFYYK.js.map

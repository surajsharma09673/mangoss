...
_ProductDetailComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductDetailComponent, selectors: [["app-product-detail"]], decls: 1, vars: 1, consts: [["class", "container", 4, "ngIf"], [1, "container"], [1, "row", "mt-3", "mb-3"], [1, "col-md-12"], [1, "btn", "btn-primary", 3, "click"], [1, "row"], [1, "col-md-6"], [1, "img-fluid", 3, "src", "alt"], [1, "d-flex", "justify-content-between", "align-items-start", "flex-wrap"], [1, "btn", "btn-info", "mt-2", 3, "click"], [1, "badge", "badge-light"], [1, "text-danger", 2, "font-size", "24px", "font-weight", "bold"], [1, "badge", "bg-warning", "text-white"], [1, "description-container"], [1, "mt-3"], [1, "btn", "btn-success", 3, "click"], [1, "mt-2"], ["for", "quantity"], ["type", "number", "id", "quantity", "placeholder", "1", "min", "1", 1, "form-control", "quantity-input", 3, "ngModel", "ngModelChange"]], template: function ProductDetailComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-HHAIQV7W.js.map

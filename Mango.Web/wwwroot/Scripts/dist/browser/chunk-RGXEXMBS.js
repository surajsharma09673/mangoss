...
_OrderDetailsCardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderDetailsCardComponent, selectors: [["app-order-details-card"]], inputs: { cardDetails: "cardDetails", cartHeader: "cartHeader" }, decls: 27, vars: 13, consts: [[1, "card", "mt-2"], [1, "card-body"], [1, "d-none", "d-lg-block"], [1, "row", "text-danger"], [1, "col-6"], [1, "col-3"], ["class", "row h-100", 4, "ngFor", "ngForOf"], [1, "row"], [1, "col-12", "text-center", "pr-4", "text-danger"], [1, "text-success"], [1, "card-footer"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-success", "form-control"], [1, "row", "h-100"], [2, "font-size", "20px"], [1, "col-3", 2, "font-size", "11px"], [2, "font-size", "17px"]], template: function OrderDetailsCardComponent_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" Order Total: ", \u0275\u0275pipeBind4(16, 3, ctx.cartHeader == null ? null : ctx.cartHeader.cartTotal, "USD", "symbol", "1.2-2"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" Order Discount: ", \u0275\u0275pipeBind4(20, 8, ctx.cartHeader == null ? null : ctx.cartHeader.discount, "USD", "symbol", "1.2-2"), "");
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrderDetailsCardComponent, { className: "OrderDetailsCardComponent", filePath: "src\\app\\HomePage\\cart\\order-details-card\\order-details-card.component.ts", lineNumber: 10 });
})();
...
var _OrderSummaryComponent = class _OrderSummaryComponent {
  ...
  constructor(fb, cartService, zone) {
    this.fb = fb;
    this.cartService = cartService;
    this.zone = zone;
    this.orderDetails = [];
...
_OrderSummaryComponent.\u0275fac = function OrderSummaryComponent_Factory(t) {
  return new (t || _OrderSummaryComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(CartService), \u0275\u0275directiveInject(NgZone));
};
_OrderSummaryComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderSummaryComponent, selectors: [["app-order-summary"]], decls: 31, vars: 3, consts: [[3, "formGroup", "ngSubmit"], [1, "container", "mt-4"], [1, "card", "border", "mt-2", "p-4", "rounded"], [1, "row"], [1, "col-md-7", "col-12"], [1, "text-warning", "mb-2"], [1, "col-md-5", "col-12", "text-end"], ["routerLink", "../cart", 1, "btn", "btn-outline-warning"], [1, "row", "mt-4"], [1, "row", "mb-3"], [1, "col-12"], ["formControlName", "firstName", "placeholder", "First name...", 1, "form-control"], [1, "col-12", "mt-2"], ["formControlName", "lastName", "placeholder", "Last name...", 1, "form-control"], ["formControlName", "email", "placeholder", "Email...", 1, "form-control"], ["formControlName", "phoneNumber", "placeholder", "Phone number...", 1, "form-control"], [1, "col-12", "mt-3"], [1, "col-form-label"], [1, "col-md-5", "col-12"], [3, "cardDetails", "cartHeader"], [1, "col-12", "text-center"], ["type", "submit", 1, "btn", "btn-success"]], template: function OrderSummaryComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(23, " Order will be ready in 30 minutes after placing the order. If you place an order when the restaurant is closed, it will be ready the next day. ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(24, "div", 18);
    \u0275\u0275element(25, "app-order-details-card", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 8)(27, "div", 20)(28, "button", 21)(29, "span");
    \u0275\u0275text(30, "Place Order");
    \u0275\u0275elementEnd()()()()()()();
  }
  if (rf & 2) {
    \u0275\u0275property("formGroup", ctx.orderForm);
    \u0275\u0275advance(25);
    \u0275\u0275property("cardDetails", ctx.cartDetails)("cartHeader", ctx.cartHeader);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrderSummaryComponent, { className: "OrderSummaryComponent", filePath: "src\\app\\HomePage\\cart\\order-summary\\order-summary.component.ts", lineNumber: 13 });
})();
...
//# sourceMappingURL=chunk-RGXEXMBS.js.map

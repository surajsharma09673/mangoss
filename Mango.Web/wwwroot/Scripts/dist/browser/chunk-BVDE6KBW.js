...
function ProductDetailComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "Go Back");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(5, "div", 2)(6, "div", 5);
    \u0275\u0275element(7, "img", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 5)(9, "h2");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 10)(20, "a", 11);
    \u0275\u0275listener("click", function ProductDetailComponent_div_0_Template_a_click_20_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ProductDetailComponent_div_0_Template_button_click_22_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.viewCart());
    });
    \u0275\u0275text(23, "View Cart ");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(13, 7, ctx_r0.product.price, "USD", "symbol", "1.2-2"));
    \u0275\u0275advance(3);
...
_ProductDetailComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductDetailComponent, selectors: [["app-product-detail"]], decls: 1, vars: 1, consts: [["class", "container", 4, "ngIf"], [1, "container"], [1, "row"], [1, "col-md-12"], [1, "btn", "btn-primary", 3, "click"], [1, "col-md-6"], [1, "img-fluid", 3, "src", "alt"], [1, "text-danger", 2, "font-size", "24px", "font-weight", "bold"], [1, "badge", "bg-warning", "text-white"], [1, "description-container"], [1, "mt-3"], ["href", "#", 1, "btn", "btn-success", 3, "click"], [1, "btn", "btn-info", "ml-2", 3, "click"], [1, "badge", "badge-light"]], template: function ProductDetailComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ProductDetailComponent_div_0_Template, 26, 12, "div", 0);
  }
  if (rf & 2) {
...
//# sourceMappingURL=chunk-BVDE6KBW.js.map

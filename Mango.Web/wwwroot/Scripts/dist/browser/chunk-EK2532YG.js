...
function LoginComponent_div_0_div_16_Template(rf, ctx) {
  if (rf & 1) {
...
function LoginComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LoginComponent_div_0_Template_button_click_2_listener() {
      ...
      return \u0275\u0275resetView(ctx_r4.toggleLoginPopup());
    });
    ...
    \u0275\u0275listener("ngSubmit", function LoginComponent_div_0_Template_form_ngSubmit_5_listener() {
      ...
      return \u0275\u0275resetView(ctx_r6.onSubmit());
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, LoginComponent_div_0_div_16_Template, 2, 1, "div", 10);
    \u0275\u0275elementStart(17, "button", 11);
    \u0275\u0275text(18, "Login");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "button", 12);
    \u0275\u0275listener("click", function LoginComponent_div_0_Template_button_click_19_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r7 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r7.navigateToRegister());
    });
    \u0275\u0275text(20, " Register ");
    \u0275\u0275elementEnd()()()();
  }
...
var _LoginComponent = class _LoginComponent {
  constructor(loginservice, formService, router, popupService, tokenService, LoaderService2) {
    this.loginservice = loginservice;
    this.formService = formService;
    this.router = router;
    this.popupService = popupService;
    this.tokenService = tokenService;
    this.LoaderService = LoaderService2;
    this.showLogin = true;
    this.errorMessage = "";
    console.log("login");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src\\app\\HomePage\\Account\\login\\login.component.ts", lineNumber: 19 });
})();
...
//# sourceMappingURL=chunk-EK2532YG.js.map

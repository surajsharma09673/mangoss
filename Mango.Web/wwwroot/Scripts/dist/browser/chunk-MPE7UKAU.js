...
var _OrderService = class _OrderService {
  ...
  UpdateOrderStatus(orderId, newstatus) {
    {
      return this.http.post(this.EndpointService.endpoints.UpdateOrderStatus + orderId, newstatus);
    }
  }
};
...
_OrderListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderListComponent, selectors: [["app-order-list"]], decls: 18, vars: 0, consts: [[1, "container"], [1, "table", "table-striped"]], template: function OrderListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "h1");
    \u0275\u0275text(2, "Order List");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "table", 1)(4, "thead")(5, "tr")(6, "th");
    \u0275\u0275text(7, "Order ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th");
    \u0275\u0275text(9, "Email");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrderListComponent, { className: "OrderListComponent", filePath: "src\\app\\HomePage\\cart\\checkout\\order-list\\order-list.component.ts", lineNumber: 9 });
})();
...
//# sourceMappingURL=chunk-MPE7UKAU.js.map

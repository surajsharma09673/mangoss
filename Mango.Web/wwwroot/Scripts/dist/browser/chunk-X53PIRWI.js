...
function ProductDetailComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ProductDetailComponent_div_0_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ProductDetailComponent_div_0_Template_input_ngModelChange_25_listener($event) {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275listener("click", function ProductDetailComponent_div_0_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r5 = \u0275\u0275nextContext();
...
_ProductDetailComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductDetailComponent, selectors: [["app-product-detail"]], decls: 1, vars: 1, consts: [["class", "container", 4, "ngIf"], [1, "container"], [1, "row", "mt-3", "mb-3"], [1, "col-md-12"], [1, "btn", "btn-primary", 3, "click"], [1, "row"], [1, "col-md-6"], [1, "img-fluid", 3, "src", "alt"], [1, "text-danger", 2, "font-size", "24px", "font-weight", "bold"], [1, "badge", "bg-warning", "text-white"], [1, "description-container"], [1, "mt-3"], [1, "btn", "btn-success", 3, "click"], [1, "mt-2"], ["for", "quantity"], ["type", "number", "id", "quantity", "placeholder", "1", "min", "1", 1, "form-control", "quantity-input", 3, "ngModel", "ngModelChange"], [1, "btn", "btn-info", "mt-2", 3, "click"], [1, "badge", "badge-light"]], template: function ProductDetailComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ProductDetailComponent_div_0_Template, 30, 13, "div", 0);
  }
  if (rf & 2) {
...
//# sourceMappingURL=chunk-X53PIRWI.js.map
